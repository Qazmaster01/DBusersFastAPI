...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        literal_binds=True,
        dialect_opts={"paramstyle": "named", "client_encoding": "utf8"},  # добавляем опцию client_encoding
    )
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            connection=connection, target_metadata=target_metadata, dialect_opts={"client_encoding": "utf8"}  # добавляем опцию client_encoding
        )
